...
python "${BUILD_SCRIPT}" "${BUILD_DIR}" --without calib3d --without cudaarithm --without cudabsegm --without cudacodec --without cudafeatures2d --without cudafilters --without cudaimgproc --without cudalegacy --without cudaobjdetect --without cudaoptflow --without cudastereo --without cudawarping --without cudev --without dnn --without flann --without java --without js --without ml --without python --without shape --without stitching --without superres --without ts --without video --without videoio --without videostab --without viz --without world
